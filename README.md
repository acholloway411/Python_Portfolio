# Python_Portfolio_Allyson_Holloway
...
def fahr_to_celsius(temp):
    # Return converted values more effeciently using the retun function
    # a new variable. This coe does the same thing as the previous function but it is more
...
```
    ...
    <ipython-input-39-eed2471d229b> in <module>
...
```
    ...
    Traceback (most recent call last):
      ...
      File "<ipython-input-26-d0d3ef43afeb>", line 1, in <module>
        numpy.loadtxt('inflammation-01.csv', ',')
...
```
    ...
    <ipython-input-1-92fe4b03414b> in <module>
          2 total = 0.0
          3 for n in numbers:
...
```
    ...
    <ipython-input-2-ee5a3d552d0a> in normalize_rectangle(rect)
